    ...
    public class EventoService : IEventoService
    {
        ...
        public async Task<Evento> AddEventos(Evento model)
        {
            try
            {
                ...
                else throw new Exception("Erro ao adicionar evento. (_geralPersist.SaveChangesAsync)");
            }
            catch (Exception ex)
            {
        ...
        public async Task<Evento> UpdateEvento(int eventoId, Evento model)
        {
            try
            {
                ...
                else throw new Exception("Erro ao atualizar o evento. (_geralPersist.SaveChangesAsync)");
            }
            catch (Exception ex)
            {                
                throw new Exception(ex.Message);
